...
include('../crypt.php');
    ...
    $insert_details = "INSERT INTO JQ_Schools(P1_Name, P2_Name, S_Name, M_No1, M_No2) VALUES(?, ?, ?, ?, ?)";
...
?>
    <div id="content">
        <form method="post" action="submit.php" autocomplete=false>
            <p class="content-heading">Junior Quiz Prelims</p>
                <ol class="content-list">
                 <?php 
                 $extract_questions="SELECT * FROM JQ_Questions";

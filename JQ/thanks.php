...
include('database.php');
    ...
    $insert_score = "UPDATE JQ_Schools SET Score = ? WHERE S_Id = ?";
    ...
    $stmt->close();
    $update_states = "UPDATE JQ_Answers SET A1S = ?, A2S = ?, A3S = ?, A4S = ?, A5S = ?, A6S = ?, A7S = ?, A8S = ?, A9S = ?, A10S = ?, A11S = ?, A12S = ?, A13S = ?, A14S = ?, A15S = ?, A16S = ?, A17S = ?, A18S = ?, A19S = ?, A20S = ? WHERE S_Id = ?";
